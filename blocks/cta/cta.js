export default function decorate(block) {
  ...
  if (specificPTag) {
    specificPTag.classList.add(
      ...'ptag lg:text-2xl font-light lg:mb-16 mb-10 lg:mx-0 text-xl text-slate-600'.split(' '),
    );
  }
  ...
  btn.classList.add(
    ...'font-blod text-xl font-bold border-black border-2 lg:w-2/12 lg:m-auto mx-6 w-auto rounded-3xl p-2 transform hover:scale-103'.split(
      ' ',
    ),
  );
}
